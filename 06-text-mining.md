...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/lcm-map-1.png" alt="Geographic distribution of LCM transcriptomics research, with top 10 cities labeled. Number of publications is binned over longitude and latitude." width="1152" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/topics-1.png" alt="Top words for each of the 50 topics, ordered by expected topic prevalence and showing top 5 words contributing to each topic." width="768" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/topic-words-1.png" alt="Probability of top 10 words in each topic." width="1152" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/topic-corr-1.png" alt="Correlation between topics." width="1152" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/wbt-1.png" alt="(ref:wbt-cap)" width="1152" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/word-heat-1.png" alt="Heat map clustering changes in word frequency over time. The rows of the matrix are normalized, only showing trend rather than frequency." width="768" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/topic-trends-1.png" alt="(ref:tt-cap)" width="1152" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/topic-count-1.png" alt="Number of abstracts with each topic whose proportions changed the most in time. Gray ribbon is the 95% CI of the line fitted to the count per year." width="1152" />
<p class="caption">(\#fig:topic-count)Number of abstracts with each topic whose proportions changed the most in time. Gray ribbon is the 95% CI of the line fitted to the count per year.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/topic-corr-trend-1.png" alt="Correlation between topics colored by both broad categories of the topics and whether its proportion increased, decreased, or did not significantly change (n.s.)." width="1152" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/topic-loc-1.png" alt="Cities associated with topics (p &lt; 0.005) shown on a map." width="1152" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/city-pe-1.png" alt="Proportion of topic 45 in each city. Error bars are 95% CI of the point estimate." width="576" />
<p class="caption">(\#fig:city-pe)Proportion of topic 45 in each city. Error bars are 95% CI of the point estimate.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/pc12-1.png" alt="Projection of word embeddings into the first 2 PCs. Each point is a word occuring over 30 times in the corpus. Not all words are labeled to avoid overlaps in the labels. Words and points are colored by Louvain clusters." width="864" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/pc34-1.png" alt="Projection of word embeddings into the 3rd and 4th PCs." width="864" />
...
<div class="figure" style="text-align: center">
<img src="06-text-mining_files/figure-html/umap-1.png" alt="UMAP projection of word embeddings." width="1248" />
<p class="caption">(\#fig:umap)UMAP projection of word embeddings.</p>
</div>
