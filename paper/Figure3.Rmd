...
```{r}
nms <- c("Prequel", "ROI selection", "smFISH", "NGS barcoding", "ISS", "No priori")
...
```{r}
(p3j <- pubs_per_cat(langs, language, n_top = 5, isotype = TRUE, img_unit = 20) +
...
```{r}
(p3k <- pubs_per_cat(analysis_langs, language, n_top = 5, isotype = TRUE, img_unit = 20) +
