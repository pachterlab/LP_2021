...
```{r pa-map, fig.width=8, fig.height=4, fig.cap="Number of publications per city for prequel data analysis."}
...
```{r pa-species2, fig.width=8, fig.height=12, fig.cap="Number of publications per city for prequel data analysis broken down by species of interest."}
