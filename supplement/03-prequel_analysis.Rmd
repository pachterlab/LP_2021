...
```{r prequel-poly, fig.width=7, fig.height=4, fig.cap="Comparing trends in data collection and data analysis in the prequel era. Bin width is 365 days."}
...
```{r pa-map, fig.width=10, fig.height=5, fig.cap="Number of publications per city for prequel data analysis."}
pubs_on_map2(prequel_analysis)
```

```{r pa-map-us, fig.width=9, fig.height=6, fig.cap="Number of publications per city for prequel data analysis in the US."}
...
```{r pa-species2, fig.width=10, fig.height=15, fig.cap="Number of publications per city for prequel data analysis broken down by species of interest."}
