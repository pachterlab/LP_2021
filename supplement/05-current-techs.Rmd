...
(ref:smfish-lm-cap) Number of genes, averaged over datasets in each study, over time. Gray ribbon is 95% confidence interval (CI).
...
How total number cells profiled in each study that reported the number of cells in the main text is shown here. 
```{r}
sum_cells <- smfish %>% 
  group_by(date_published, title, method) %>% 
