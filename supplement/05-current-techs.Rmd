...
```{r voxelation, fig.cap="(ref:vox)", out.width="1.27in", out.height="2.12in"}
...
```{r tomo, out.width="2in", out.height="2.1in", fig.cap="Tomo-seq, here showing C. elegans."}
...
```{r niche, out.width="2.5in", out.height="2in", fig.cap="Niche-seq schematics. Green: cells with photoactivated PA-GFP."}
...
```{r smfish, out.width="2.94in", out.height="1.26in", fig.cap="(ref:smfish-cap)"}
...
```{r array-dims, out.width="2.8in", out.height="3.5in", fig.cap="Schematic of spot construction and size of array based techniques."}
knitr::include_graphics("fig13a.png")
```

```{r array-umi,out.width="2.8in", out.height="3.5in", fig.cap="Barcode and UMI structure and lengths of array based techniques."}
