...
5. Number of all UMI and genes detected per unit area in one NGS based spatial technique is compared to those of other NGS based spatial techniques. This was performed for DBiT-seq, Visium (FFPE), Stereo-seq, PIXEL-seq, and Seq-Scope.
