...
```{r dsp-organs, fig.width=8, fig.height=6, fig.cap="Number of GeoMX DSP or WTA studies for healthy and pathological human organs. Male is shown here because there are studies for the prostate but not for female specific organs."}
hg_h + hg_p +
...
```{r visium-organs, fig.width=8, fig.height=6, fig.cap="(ref:hg-visium-cap)"}
hg_h + hg_p +
  plot_annotation(tag_levels = "A")
```
...
```{r visium-organs-mm, fig.width=8, fig.height=6, fig.cap="Number of Visium studies for healthy (A) and pathological (B) mouse organs. Female is shown here as there is a uterus study while there is no study on male specific organs in our database."}
mm_h + mm_p +
  plot_annotation(tag_levels = "A")
```
