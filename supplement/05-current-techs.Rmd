...
```{r voxelation, fig.cap="(ref:vox)", out.width="20%"}
...
```{r tomo, out.width="30%", fig.cap="Tomo-seq, here showing C. elegans."}
...
```{r niche, out.width="35%", fig.cap="Niche-seq schematics. Green: cells with photoactivated PA-GFP."}
...
```{r smfish, out.width="50%", fig.cap="(ref:smfish-cap)"}
...
```{r smfish-lm-gene, fig.width=9, fig.height=6, fig.cap="Number of genes, averaged over datasets in each study, over time. The studies profiling 10,000 genes are excluded to better show the trend among more ordinary studies. Gray ribbon is standard error."}
...
```{r smfish-map, fig.width=10, fig.height=6.5, fig.cap="(ref:smfish-map-cap)"}
...
```{r array-map, fig.height=13.75, fig.width=10, fig.cap="Cities and institutions using ST and Visium. Preprints are included."}
...
```{r array-dims, out.width="50%", fig.cap="Schematic of spot construction and size of array based techniques."}
knitr::include_graphics("fig13a.png")
```

```{r array-umi, out.width="50%", fig.cap="Barcode and UMI structure and lengths of array based techniques."}
