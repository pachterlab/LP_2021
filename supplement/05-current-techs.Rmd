...
```{r niche, out.width="50%", fig.cap="Niche-seq schematics. Green: cells with photoactivated PA-GFP."}
...
```{r smfish, out.width="60%", fig.cap="(ref:smfish-cap)"}
...
```{r array-dims, out.width="60%", fig.cap="Schematic of spot construction and size of array based techniques."}
knitr::include_graphics("fig13a.png")
```

```{r array-umi, out.width="60%", fig.cap="Barcode and UMI structure and lengths of array based techniques."}
