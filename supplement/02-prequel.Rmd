...
```{r prequel-world, fig.width=8, fig.height=4, fig.cap="Number of prequel publications per city around the world, with top contributing institutions labeled."}
...
```{r map-species, fig.width=8, fig.height=10, fig.cap="Number of prequel publications per city broken down by species. Gray points are the overall number as a reference of contributions from each city and region."}
...
```{r map-tech, fig.width=8, fig.height=8, fig.cap="Number of prequel publications per city broken down by technique. Gray points are the overall number as a reference of contributions from each city and region."}
prequel %>% 
